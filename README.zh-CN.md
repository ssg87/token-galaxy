...
- 大窗口是一片缓慢流动的宇宙：主任务各自形成较大的星云，自然散落，子任务环绕所属主任务，保留主子连线和活动反馈。当前读取范围内的记录全部进入总览，刷新和自动切换不打乱位置；点击“重排宇宙”可平滑换一种分布。只有点击星云或任务行后才显示对应任务名，悬停、工作中和自动切换不显示名字。子任务贴近主星云外围，主子连线改为短而轻的连接。小悬浮球保持紧凑布局。
